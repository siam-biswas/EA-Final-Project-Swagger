...
import localhost8089.Environment;
import localhost8089.testing.HttpCallbackCatcher;
...
public class BaseControllerTest {
     ...
     */
    protected static EAFinalProjectClient createConfigurationFromEnvironment() {
        EAFinalProjectClient.Builder builder = new EAFinalProjectClient.Builder();

        final String environment = System.getenv("EA_FINAL_PROJECT_LIB_ENVIRONMENT");
        final String timeout = System.getenv("EA_FINAL_PROJECT_LIB_TIMEOUT");
     ...
     */
    protected static EAFinalProjectClient createConfiguration() {
        // Set Configuration parameters for test execution
        EAFinalProjectClient config = createConfigurationFromEnvironment();
